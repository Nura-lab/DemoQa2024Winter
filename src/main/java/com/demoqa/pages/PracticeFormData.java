...
public class PracticeFormData extends BasePage {
    ...
    public PracticeFormData selectDateMonthYear(String dateMonthYear) {
        ...
        dropDownHelper.selectByVisibleText(yearDropDown, year);
